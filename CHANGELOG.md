...
### Released
- Released **ai-incident-card-spec** publicly as a reviewable operating system for answer-engine visibility.
...
### Shipped
- Cut the first coherent internal version of **ai-incident-card-spec** with stable domain objects, review surfaces, and decision outputs.
