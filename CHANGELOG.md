...
### Released
- Published **ai-incident-card-spec** as a public, portfolio-grade platform governance system.
...
### Shipped
- Cut the first coherent internal version of the product shape behind **ai-incident-card-spec**.
- Standardized the core objects, decision surfaces, and operator outputs around the repo's main working problem.
- Established the first reviewable version of the architecture described as: Open JSON spec for vendor-published AI incident disclosure — the CVE-equivalent for AI agent failures. Cross-references every other affected Kinetic Gain Suite document. v0.1 draft.
...
- That insight became the basis for **ai-incident-card-spec**.
